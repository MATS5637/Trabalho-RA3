...
Este projeto implementa um monitor de recursos de processos Linux, conforme especificado no PDF do Trabalho RA3.
Ele coleta métricas de:
...
4.1. Modo Interativo (recomendado)
./bin/resource-monitor
...
4.2. Modo Linha de Comando (automação)
🔹 Monitorar CPU
./bin/resource-monitor cpu <PID> <intervalo_ms> <amostras>

🔹 Monitorar Memória
./bin/resource-monitor mem <PID>

🔹 Monitorar I/O
./bin/resource-monitor io <PID> <intervalo_ms> <amostras>

🔹 Namespaces de um processo
./bin/resource-monitor ns <PID>

🔹 Criar Cgroup
./bin/resource-monitor cgroup-create <nome> <cpu_cores> <mem_mb>

🔹 Adicionar processo ao Cgroup
./bin/resource-monitor cgroup-add <nome> <PID>
...
chmod +x scripts/compare_tools.sh
./scripts/compare_tools.sh <PID> <intervalo_ms> <amostras>
